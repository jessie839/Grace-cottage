...
export default function SettingsPage() {
  ...
  const handleClearData = () => {
    if (confirm('Are you sure? This will delete all photos and data. This action cannot be undone.')) {
      localStorage.clear()
      logout()
      router.push('/login')
    }
      ...
      <main className="w-full max-w-2xl mx-auto px-4 py-6 pb-24 md:pb-8">
        ...
        <Card className="p-6 bg-gradient-to-br from-primary/10 to-transparent border border-primary/20">
          ...
          <p className="text-xs text-muted-foreground">
            A beautiful photo management system for Grace Cottage events.
            Made with care for preserving precious memories.
          </p>
        </Card>
      </main>
    </MobileLayout>
